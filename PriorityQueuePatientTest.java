...
public class PriorityQueuePatientTest {

	public static final Comparator<Patient> pqComparator = new Comparator<Patient>(){
...
public static void main(String[] args) {
    ...
    PriorityQueue<Patient> patientQueue = new PriorityQueue<Patient>(10, PriorityQueuePatientTest.pqComparator);
